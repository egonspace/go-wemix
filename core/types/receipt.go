...
func (r *Receipt) decodeTyped(b []byte) error {
	...
	switch b[0] {
	case DynamicFeeTxType, AccessListTxType, BlobTxType, FeeDelegateDynamicFeeTxType:
		var data receiptRLP
...
func (rs Receipts) EncodeIndex(i int, w *bytes.Buffer) {
	...
	w.WriteByte(r.Type)
	switch r.Type {
	case AccessListTxType, DynamicFeeTxType, BlobTxType, FeeDelegateDynamicFeeTxType:
		rlp.Encode(w, data)
	default:
