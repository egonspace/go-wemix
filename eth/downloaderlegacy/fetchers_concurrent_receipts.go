...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *mir.Response) (*mir.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *mir.Response) (int, error) {
	receipts := *packet.Res.(*mir.ReceiptsPacket)
