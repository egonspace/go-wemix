...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *mir.Response) (*mir.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *mir.Response) (int, error) {
	txs, uncles := packet.Res.(*mir.BlockBodiesPacket).Unpack()
