...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *mir.Response) (*mir.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *mir.Response) (int, error) {
	headers := *packet.Res.(*mir.BlockHeadersPacket)
