...
type Downloader struct {
	...
	blockchain downloader.BlockChain
...
func New(checkpoint uint64, stateDb ethdb.Database, mux *event.TypeMux, chain downloader.BlockChain, dropPeer peerDropFn, success func()) *Downloader {
	dl := &Downloader{
		stateDB:        stateDb,
		mux:            mux,
...
func (d *Downloader) fetchHead(p *peerConnection) (head *types.Header, pivot *types.Header, err error) {
	...
	head = headers[0]
	if mode == SnapSync && head.Number.Uint64() < d.checkpoint {
